...
<body>
    <div class="container">
        ...
        <select name="town" id="town" class="form-control" style="width: 230px;">
    ...
    function populateBarangayTable(barangays) {
        ...
        barangays.forEach(function(barangay, index) {
            ...
            tableHTML += "<button class='edit-button' onclick='editField(" + index + ", \"brgy_captain\")'>Edit Barangay Captain</button><br>";
            tableHTML += "<button class='edit-button' onclick='editField(" + index + ", \"brgy_captain_number\")'>Edit Barangay Captain Contact Info</button><br>";
            tableHTML += "<button class='edit-button' onclick='editField(" + index + ", \"brgy_secretary\")'>Edit Barangay Secretary</button><br>";
            tableHTML += "<button class='edit-button' onclick='editField(" + index + ", \"brgy_secretary_number\")'>Edit Barangay Secretary Contact Info</button><br>";
            tableHTML += "</div>";
            tableHTML += "</td>";
            tableHTML += "</tr>";
        });
